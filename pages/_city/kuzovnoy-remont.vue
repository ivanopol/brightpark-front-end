    ...
    <div class="container_bg_dark">
      <div class="container">
        <FormService  :form_id="$store.state._page + '__sign-up-for-a-service_'"
                      :button_text="'Записаться на кузовной ремонт'"
                      :form_title="''"
                      :is_comment='true'
                      :form_h1="'<span class=\'c_orange\'>Запишись</span> на кузовной ремонт'"
    ...
    <div class="container_bg_dark">
      <div class="container">
        <FormRetarget :form_id="$store.state._page + '__sign-up-to-our-service_'"
                      :button_text="'Записаться на кузовной ремонт'"
                      :form_title="'<span class=\'c_orange\'>Запишись</span> к нам на кузовной ремонт'"
