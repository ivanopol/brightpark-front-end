    ...
    .trust-us {
        ...
        &-rating-stars {
            ul {
                ...
                li {
                    margin-right: 4px;
                    background: url(/images/icons/service/star-off.svg) no-repeat;
                    width: 20px;
                    height: 20px;
                    display: block;

                    &.rating-active {
                        background: url(/images/icons/service/star-on.svg) no-repeat;
                    }
                }
            }
        }
