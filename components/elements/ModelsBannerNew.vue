      ...
      <div class="banner__inner">
        <div class="banner__inner__car color-svg-figure">
          <div class="banner__inner__car__hit" v-if="isHit">
            <div v-if="model.toLowerCase() === 'vesta'">
              <img src="/images/icons/hit.png" alt="Хит">
            </div>
              <span v-if="model.toLowerCase() !== 'vesta'">
                хит продаж
              </span>
              <svg v-if="model.toLowerCase() !== 'vesta'" width="135" height="104" viewBox="0 0 135 104" fill="none" xmlns="http://www.w3.org/2000/svg">
