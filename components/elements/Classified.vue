<template>
    <section id="classified">
        ...
        <div class="dropdown-group">
            <v-select :id="'select_make'" class="select_wrap event" :class="{ active : step_one }"  :searchable=false placeholder="Марка"
                      taggable
            ...
            <v-select id="select_model" :disabled="!step_one" class="select_wrap event" :class="{ active : step_two }" :searchable=false
                       placeholder="Модель" v-on:input="stepTwo" taggable
                      :options="models" v-model="selected_model">
                <div class="spinner" v-show="mutableLoading">Загрузка...</div>
                <div slot="no-options">Нет совпадений</div>
            </v-select>
            <v-select id="select_gen" :disabled="!step_two" class="select_wrap event" :class="{ active : step_three }"
                      :searchable=false
            ...
            <v-select id="select_year" :disabled="!step_three" class="select_wrap event" :class="{ active : step_four }"
                      :searchable=false
            ...
            <v-select id="select_kmage" :disabled="!step_four" class="select_wrap event" :class="{ active : step_five }"
                      :searchable=false
...
/*            hidePrices: function() {
            ...
            stepTwo: function (input) {
               ...
               // this.hidePrices();
                axios.get(process.env.apiUrl + '/api/get_complectations/' + this.selected_brand.code.toString() + '/' + input.code.toString(),
                    {})
                    .then((response) => {
