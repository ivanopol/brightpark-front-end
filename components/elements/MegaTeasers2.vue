<template>
  <section class="buttons-block container p-top-40">
    <ul class="buttons-block-list">
      <li>
        <img loading=lazy :id="$store.state._page + '__image-buttons__profitable-credit'" class="buttons-block-list-credit event" src="~static/images/main/buttons_block/profitable_credit.png" alt="Брайт Парк: выгодный кредит"
