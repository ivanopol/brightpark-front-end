<template>
  <section class="buttons-block container p-top-40">
    <ul class="buttons-block-list">
      ...
      <li>
        <img loading=lazy id="main__image-buttons__special-offer" class="buttons-block-list-special-offer event" src="~static/images/main/buttons_block/special_offer.png" alt="Брайт Парк: Получить специальное предложение"
    ...
    <modal name="form-callback2" height="auto" :adaptive="true">
      ...
      <FormBuy3Component :form_title="form_title"
                         :form_id="form_id"
