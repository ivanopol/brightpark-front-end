    ...
    <section class="car-services container">
        ...
        <div class="container">
          <client-only placeholder="Загружается...">
            <BadgerAccordion>
                <BadgerAccordionItem v-for="(service, index) in services" v-bind:key="service.id">
...
<script>
    export default {
        ...
        data: function () {
            return {
                form_title: '',
                form_id: this.$store.state._page + '__modal',
                ...
                services: {
                    maintenance: {
                        ...
                        alias: this.$store.state._page + '__modal-maintenance_',
                        list: {
                            0: {
                    ...
                    locksmith_repair: {
                        ...
                        alias: this.$store.state._page + '__modal-locksmith-repair_',
                        list: {
                            0: {
                                title: 'Диагностика',
                                price: 0,
                    ...
                    car_care: {
                        ...
                        alias: this.$store.state._page + '__modal-car-care_',
                        list: {
                            0: {
