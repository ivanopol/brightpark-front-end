<template>
        <form action="#" :id="form_id" method="POST" class="feedback__form" name="feedback" @submit="send"
              :data-goal="goal">
          ...
          <label class="form__input-wrapper">
            ...
            <a :id="form_id + '_call'"
                       ...
                       class="callibri_phone btn-position event feedback__form__call">Позвонить</a>
...
<style lang="scss" scoped>
  ...
  .feedback__form__submit {
    @include basic-button($width: 80%, $maxWidth: 340px, $height: 48px, $fz: 16px);
  ...
  .feedback__form__call {
    @include basic-button($width: 80%, $maxWidth: 340px, $height: 48px, $bgColor: $secondary-color, $fz: 16px);
